...
def computeStrengthValues(bag, agg_f, inf_f):
    ...
    for arg in order:
        # # print("========================================")
        # # print(f"arg:{arg.get_name()}")
        # support_value, attack_value, agg = agg_f.aggregate_strength(arg.attackers, arg.supporters, strength)
        # s, support_value, attack_value = inf_f.compute_strength(arg.initial_weight, support_value, attack_value, agg)
        #
        # arg.strength = s
        # arg.strength_att = attack_value
        # arg.strength_sup = support_value
        #
        # strength[arg] = s
        # # print(f"strength:{arg.get_strength()}")
